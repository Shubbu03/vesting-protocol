...
export function identifyVestingInstruction(
  ...
  if (
    ...
    return VestingInstruction.Close;
  }
  if (
    containsBytes(
      data,
    ...
    return VestingInstruction.Decrement;
  }
  if (
    containsBytes(
      data,
    ...
    return VestingInstruction.Increment;
  }
  if (
    containsBytes(
      data,
    ...
    return VestingInstruction.Initialize;
  }
  if (
    containsBytes(
      data,
...
> =
  | ({
      instructionType: VestingInstruction.Close;
    } & ParsedCloseInstruction<TProgram>)
  | ({
      instructionType: VestingInstruction.Decrement;
    } & ParsedDecrementInstruction<TProgram>)
  | ({
      instructionType: VestingInstruction.Increment;
    } & ParsedIncrementInstruction<TProgram>)
  | ({
      instructionType: VestingInstruction.Initialize;
    } & ParsedInitializeInstruction<TProgram>)
  | ({
      instructionType: VestingInstruction.Set;
