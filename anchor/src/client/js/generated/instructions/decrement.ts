...
export type DecrementInput<TAccountVesting extends string = string> = {
...
>(
  input: DecrementInput<TAccountVesting>,
  config?: { programAddress?: TProgramAddress }
): DecrementInstruction<TProgramAddress, TAccountVesting> {
  // Program address.
  ...
  } as DecrementInstruction<TProgramAddress, TAccountVesting>;
